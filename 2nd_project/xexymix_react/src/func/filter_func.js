 ...
 * @returns obj를 리턴, key값의 val로 필터링
 */
const filteredItem = (obj, key, val) =>
  obj.filter((v) => v[key] !== null && v[key].includes(val));
/**
...
const filteredItemSame = (obj, key, val) =>
  obj.filter((v) => v[key].includes(val) && v[key].length === val.length);
/**
